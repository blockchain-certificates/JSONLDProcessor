#
#  Be sure to run `pod spec lint JSONLDProcessor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/blockchain-certificates/JSONLDProcessor"
  ...
  s.source       = { :git => "https://github.com/blockchain-certificates/JSONLDProcessor.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "JSONLDProcessor/**/*.{swift}"
  ...
  s.resource  =  "JSONLDProcessor/index.html"
